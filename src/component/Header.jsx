...
const Header = () => {
  ...
  return (
    <section className="section_bg pt-24">
      <div className="container mx-auto px-32">
        <div className="grid grid-cols-2 items-end">
          <div className='pb-16'>
            ...
            <p id='text_color' className='pt-10 pb-5 italic'>Welcome to my personal portfolio! I'm Prakash Thakur, a passionate software developer with a keen interest in creating meaningful applications that solve real-world problems. Below you'll find some of my projects, skills, and my resume.</p>
