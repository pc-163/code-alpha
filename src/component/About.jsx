...
const About = () => {
    return (
        <>
            <section className="section_0003 py-16 bg-cover bg-center">
                <div className="container mx-auto px-32">
                    <div className="grid grid-cols-12 pb-5">
                        <div className="col-span-5">
                            ...
                            <p className="italic">Feel free to reach out to me at <a href="mailto:pcprakashchand163@email.com">pcprakashchand163@email.com</a> or connect with me on  <a href="#">LinkedIn.</a></p>
                        </div>
                    </div>
