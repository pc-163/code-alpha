                ...
                <div className="container mx-auto px-4 sm:px-4 lg:px-20 2xl:px-32">
                    <div className="lg:grid grid-cols-12 pb-5">
                        <div className="lg:col-span-7 xl:col-span-5">
                            ...
                            <p className='pt-4 pb-5 text-1xl sm:text-2xl'>I'm a dedicated developer with over 18 Months of experience in Front-End web development. I love working with technologies like React, Next.js, Node. I'm always eager to learn new things and tackle challenges head-on.</p>
